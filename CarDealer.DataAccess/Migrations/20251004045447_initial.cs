        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Complects_Models_ModelId",
                        column: x => x.ModelId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    ComplectId = table.Column<int>(type: "integer", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Cars_Complects_ComplectId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Cars_ComplectId",
                table: "Cars",
                column: "ComplectId");

            migrationBuilder.CreateIndex(
                name: "IX_Complects_ModelId",
                table: "Complects",
                column: "ModelId");
